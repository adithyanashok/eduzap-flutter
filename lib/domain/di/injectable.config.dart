...
import 'package:eduzap/application/course/course_bloc.dart' as _i14;
import 'package:eduzap/application/rating/rating_bloc.dart' as _i11;
import 'package:eduzap/application/signin/signin_bloc.dart' as _i12;
import 'package:eduzap/application/signup/signup_bloc.dart' as _i13;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i11.RatingBloc>(() => _i11.RatingBloc(gh<_i5.IRatingFacade>()));
    gh.factory<_i12.SigninBloc>(() => _i12.SigninBloc(gh<_i7.ISigninFacade>()));
    gh.factory<_i13.SignupBloc>(() => _i13.SignupBloc(gh<_i9.ISignupFacade>()));
    gh.factory<_i14.CourseBloc>(() => _i14.CourseBloc(gh<_i3.ICourseFacade>()));
    return this;
  }
}
