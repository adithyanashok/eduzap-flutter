...
class _$CourseModelImpl implements _CourseModel {
  ...
  @override
  String toString() {
    return 'CourseModel(courseTitle: $courseTitle, courseDescription: $courseDescription, courseOverview: $courseOverview, tutorName: $tutorName, rating: $rating, category: $category, lessons: $lessons, videoUrl: $videoUrl, imageUrl: $imageUrl, id: $id)';
  }
